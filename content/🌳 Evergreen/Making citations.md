...
The list of references appears at the bottom of the note by default. It can be forced elsewhere by using the command `[^ref]`.

I haven't found a ton of options to customize the format of the bibliography. It would be nice to make doi links clickable. 